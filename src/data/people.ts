...
export const revivalPeople = [
  {
    img: "/media/revival-shumilina.jpg",
    nameUk: "Ольга Шуміліна",
    textUk: "Музикознавиця, віднайшла рукопис «Креонт» у Лісабоні",
...
export const performersData = [
  {
    ...
    roleEn: "CREONTE",
    descEn:
      "Soloist of the National Philharmonic of Ukraine, international competition laureate",
  },
  {
    ...
    roleUk: "Антігона",
    descUk:
      "Солістка Національної опери України, Заслужена артистка України, лауреатка міжнародних конкурсів",
    nameEn: "Olha Fomichova",
    roleEn: "Antigona",
    descEn:
      "Soloist of the National Opera of Ukraine, Honored Artist of Ukraine",
  },
  {
    ...
    roleEn: "Emon",
    descEn:
      "Soloist of Kyiv Municipal Academic Opera & Ballet Theatre, NMAU opera studio",
  },
  {
    ...
    roleEn: "Adrast",
    descEn:
      "Soloist of Kyiv Municipal Academic Opera & Ballet Theatre, international prize-winner",
  },
  {
  ...
  },
  {
    ...
    roleUk: "Хор",
    descUk:
      "Один з найвідоміших хорових колективів України з славетними традиціями та власним стилем. Художній керівник Євген Савчук — Герой України, лауреат Національної премії України ім. Т.Г. Шевченка, Народний артист України, професор, член Академії мистецтв України",
    nameEn: "National Academic Cappella of Ukraine 'Dumka'",
    roleEn: "Choir",
    descEn:
      "Renowned Ukrainian choir. Artistic Director: Yevhen Savchuk, Hero of Ukraine, Shevchenko Prize laureate, People's Artist",
  },
  {
    ...
    roleUk: "Оркестр",
    descUk:
      "Унікальний військово-музичний колектив, елемент культурно-дипломатичної символіки держави. Від 1991 зберігає і розвиває традиції, промотує світову музичну культуру. Директор — полковник Максим Гусак",
    nameEn: "National Presidential Orchestra",
    roleEn: "Orchestra",
    descEn:
      "Unique military-musical ensemble for cultural diplomacy. Director: Colonel Maksym Husak",
  },
  {
    ...
    roleUk: "Диригент",
    descUk:
      "Диригент-постановник світової прем’єри, Народний артист України, диригент Національної опери України, художній керівник оркестру «Київ-Класик», доктор, професор, Посол української культури, Артист ЮНЕСКО в ім'я миру",
    nameEn: "Herman Makarenko",
    roleEn: "Conductor",
    descEn:
      "World premiere conductor; People's Artist of Ukraine; Kyiv Classic Orchestra artistic director; UNESCO Artist for Peace",
  },
];
